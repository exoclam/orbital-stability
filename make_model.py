...
columns = ['ebin','mubin','ap','out','binary out', 'acrits','param a'] 
...
big_batch['epsilon'] = 0.5*(big_batch['zeta']-np.floor(big_batch['zeta']))

X = np.asarray(big_batch[['ebin','mubin','param a','epsilon']])
...
model = Sequential()
model.add(Dense(48, activation='relu', input_shape=(4,)))
